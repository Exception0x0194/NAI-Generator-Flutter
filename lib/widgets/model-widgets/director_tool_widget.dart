...
class DirectorToolWidget extends StatefulWidget {
  const DirectorToolWidget({super.key, required this.config});

  final DirectorToolConfig config;
  final imageSize = 300.0;

  @override
  State<StatefulWidget> createState() => DirectorToolWidgetState();
}

class DirectorToolWidgetState extends State<DirectorToolWidget> {
  @override
