...
String exportConfigToJson(PromptConfig config) {
  return json.encode(config.toJson());
}

PromptConfig importConfigFromJson(String jsonString) {
  return PromptConfig.fromJson(json.decode(jsonString), 0);
}

void copyConfigToClipboard(PromptConfig config) {
...
Future<PromptConfig?> getConfigFromClipboard() async {
